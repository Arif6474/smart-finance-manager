                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-24 px-6 text-center bg-gradient-to-b from-card/50 to-background border border-dashed border-border/50 rounded-[50px] relative overflow-hidden group">
                        ...
                        <button
                            onClick={handleGenerate}
                            disabled={generating}
                            className="bg-primary text-white py-4.5 px-12 rounded-3xl flex items-center gap-4 text-xl font-black shadow-2xl shadow-primary/30 hover:shadow-primary/50 hover:-translate-y-1.5 transition-all active:scale-95 disabled:opacity-50"
                        >
