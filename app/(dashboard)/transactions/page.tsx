        ...
        <PageWrapper className="space-y-6">
            ...
            <div className="glass rounded-2xl overflow-hidden">
                ...
                {!loading && filteredTransactions.length > 0 && (
                    <div className="px-6 py-6 border-t border-slate-100 dark:border-slate-800 flex flex-col lg:flex-row items-center justify-between gap-6 bg-white/50 dark:bg-slate-900/50">
                        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
                            <p className="text-sm text-slate-500 font-medium">
                                Showing{' '}
                                <span className="font-bold text-foreground">{(safePage - 1) * pageSize + 1}</span>
                                {' '}–{' '}
                                <span className="font-bold text-foreground">{Math.min(safePage * pageSize, filteredTransactions.length)}</span>
                                {' '}of{' '}
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            <div className="flex items-center gap-3">
                                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Go to page</span>
                                <div className="relative group">
                                    <input
                                        ...
                                        placeholder="P#"
                                        className="w-16 h-10 bg-slate-100 dark:bg-slate-800 border-0 rounded-xl px-3 text-center text-sm font-bold focus:ring-2 focus:ring-primary outline-none transition-all group-hover:bg-slate-200 dark:group-hover:bg-slate-700"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-1.5">
                                <button
                                    ...
                                    disabled={safePage === 1}
                                    className="p-2.5 rounded-xl text-slate-400 hover:text-primary hover:bg-primary/10 transition-colors disabled:opacity-30 disabled:cursor-not-allowed border border-transparent hover:border-primary/20"
                                >
                                    <ChevronLeft size={18} />
                                </button>
